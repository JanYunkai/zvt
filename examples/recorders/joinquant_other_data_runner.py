...
def record_margin_trading():
    ...
    try:
        ...
        email_action.send_message("qguduemc@163.com", 'joinquant record margin trading finished', '')
    except Exception as e:
        msg = f'joinquant record margin trading:{e}'
        logger.exception(msg)

        email_action.send_message("qguduemc@163.com", 'joinquant record margin trading error', msg)
        time.sleep(60)
...
def record_valuation():
    while True:
        ...
        try:
            ...
            email_action.send_message("qguduemc@163.com", 'joinquant record valuation finished', '')
            break
        except Exception as e:
            msg = f'joinquant record kdata:{e}'
            logger.exception(msg)

            email_action.send_message("qguduemc@163.com", 'joinquant record valuation error', msg)
            time.sleep(60)
...
def record_others():
    while True:
        ...
        try:
            ...
            email_action.send_message("qguduemc@163.com", 'joinquant record etf finished', '')
            break
        except Exception as e:
            msg = f'joinquant record etf error:{e}'
            logger.exception(msg)

            email_action.send_message("qguduemc@163.com", 'joinquant record etf error', msg)
            time.sleep(60)
