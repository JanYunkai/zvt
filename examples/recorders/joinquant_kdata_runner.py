...
def record_stock():
    while True:
        ...
        try:
            ...
            email_action.send_message("qguduemc@163.com", 'joinquant record stock finished', '')
            break
        except Exception as e:
            msg = f'joinquant record stock:{e}'
            logger.exception(msg)

            email_action.send_message("qguduemc@163.com", 'joinquant record stock error', msg)
            time.sleep(60 * 5)
...
def record_kdata():
    while True:
        ...
        try:
            ...
            email_action.send_message("qguduemc@163.com", 'joinquant record kdata finished', '')
            break
        except Exception as e:
            msg = f'joinquant record kdata:{e}'
            logger.exception(msg)

            email_action.send_message("qguduemc@163.com", 'joinquant record kdata error', msg)
            time.sleep(60 * 5)
